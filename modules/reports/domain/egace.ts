...
/** Reads one EGACE stage count off a batch, defaulting to 0 when untracked. */
export function egaceVal(b: Batch, key: string): number {
  return b.egace ? b.egace[key as keyof EgaceCounts] ?? 0 : 0;
}

/** Sums each EGACE stage across every batch in the portfolio. */
...
/** A stage's value as a percentage of the enrolled total. */
